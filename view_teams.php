...
<body>
<div class="container">
    <h2><i class="fas fa-people-group"></i> Manage Teams</h2>
        ...
        <tbody>
            <?php $delay = 0.7; while ($row = mysqli_fetch_assoc($result)): ?>
                <tr style="animation-delay: <?= $delay ?>s">
                    ...
                    <td>
                        <a href="edit_team.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-action btn-edit">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="delete.php?type=team&id=<?= $row['id'] ?>" 
